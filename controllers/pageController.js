...
exports.sendEmail = async (req, res) => {
  ...
  `;
    ...
    let transporter = nodemailer.createTransport({
      ...
      auth: {
        user: 'tanselberkant@gmail.com', // gmail account
        pass: 'flwmcupkonkqaizt', // gmail password
      },
    });

    // send mail with defined transport object
    let info = await transporter.sendMail({
      from: '"SMART EDU Contact Form" <tanselberkant@gmail.com>', // sender address
